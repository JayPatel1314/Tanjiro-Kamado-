...
def send_start(bot, update):
    ...
    keyboard += [[InlineKeyboardButton(text="🔌 Add me",url="http://t.me/zoldycktmbot?startgroup=true"),InlineKeyboardButton(text="👤 Support chat",url="https://t.me/KamadoTanjiroOfficialSupport")]]
